...
object DataFramesBasics extends App {
  ...
  // 1
  val smartphones = Seq(
    ("Samsung", "Galaxy S8", "GrapheneOS", 8),
    ("Huawei", "P50 Pro", "Android", 50),
    ("Pine64", "PinePhone", "Manjaro with Plasma", 5),
    ("Apple", "Iphone X", "iOS", 13)
  )
  val smartphonesDF = smartphones.toDF("Company", "Model", "Operating System", "Camera")
  smartphonesDF.show()
